    ...
    public class bankFunctions {
        ...
        public static bool deposit( ref List<customer> allCustomers, ref List<account> allAccounts ){
            ...
            while (stillDepositing)
            {
                ...
                {
                    Console.WriteLine("Account Owner: " + toDeposit.owner.name);
        ...
        public static bool withdraw( ref List<customer> allCustomers, ref List<account> allAccounts ){
            ...
            while (stillWithdrawing)
            {
                ...
                if ( accountSelected && toWithdraw != null) // account chosen, enter amount and complete withdraw
                {
                    Console.WriteLine("Account Owner: " +toWithdraw.owner.name);
                ...
                {
                    basicFunctions.invalidInputEntered("Invalid Input! Account does not exist or incorrect number entered!");
                    Console.WriteLine("Enter 1 to return to Main Menu.");
                    int getCase = basicFunctions.getCase();
                    switch (getCase)
                    {
                ...
                switch ( caseCheck )
                {
                    ...
                    case 2:
                    {
                        ...
                        while ( stillClosing )
                        {
                            ...
                            {
                                basicFunctions.invalidInputEntered("Invalid Input Entered.\nEnter No to return to Menu.");
                            }
                            string answer2 = Console.ReadLine();
                            answer2 = basicFunctions.yesNoOrInvalid(answer2);

                            if ( answer2 == "Yes" && toBeClosed != null )//imhere
                            {
                                bool result = closeAccount(ref allCustomers, Cust, toBeClosed, ref allAccounts) ; //closes the account
                                if (result == true)
                                {
                    ...
                    case 3:
                    {
                        ...
                        while (stillViewing)
                        {
                            ...
                            if (proceedToPrint)
                            {
                                ...
                                Console.WriteLine("\nAccount Balance: " + toBeViewed.balance);
